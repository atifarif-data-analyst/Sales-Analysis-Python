...
| ![Revenue by Gender](reports/images/revenue_by_gender.png) | ![Spending by Age Group](reports/images/spending_by_age_group.png) |
| **Top States by Sales** | **Top Product Categories** |
| ![Top States by Sales](reports/images/top_states_by_sales.png) | ![Top Product Categories](reports/images/top_product_categories.png) |
| **Customer Segments (Frequency–Monetary)** | **Model — Top Predictive Features** |
| ![Customer Segments](reports/images/customer_segments.png) | ![Feature Importance](reports/images/model_feature_importance.png) |
